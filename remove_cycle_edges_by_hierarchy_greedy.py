...
def remove_cycle_edges_by_agony_iteratively(sccs, players, edges_to_be_removed):
    while True:
        graph = sccs.pop()
        pair_max_agony = None
        max_agony = -1
...
def scc_based_to_remove_cycle_edges_iteratively(g, nodes_score):
    ...
    remove_cycle_edges_by_agony_iteratively(big_sccs, scc_nodes_score_dict, edges_to_be_removed)
    # print(" # edges to be removed: %d" % len(edges_to_be_removed))
